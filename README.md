...
> В архиве консоли — краткая инструкция `README.txt`.
...
> упаковывает `omc-win-x64.zip` / `OfficeMetaCleaner-win-x64.zip` (в архив консоли кладёт `README.txt`) + `checksums.txt` и выкладывает в **Releases**.
