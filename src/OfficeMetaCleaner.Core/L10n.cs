...
public static class L10n
{
    ...
    public static string Status_Pending => Strings.Status_Pending;
    public static string Status_Waiting => Strings.Status_Waiting;
    public static string Status_Processing => Strings.Status_Processing;
    public static string Status_Done => Strings.Status_Done;
    public static string Status_Skipped => Strings.Status_Skipped;
    public static string Status_Error => Strings.Status_Error;
